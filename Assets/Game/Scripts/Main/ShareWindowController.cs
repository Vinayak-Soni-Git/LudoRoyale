...
public class ShareWindowController : MonoBehaviour
{
    ...
    string body = "Abb khelo ludo ghar baithe kamawo cash..Join now with my invite code and get 10Rs bonus cash. Download link :-";
    ...
    IEnumerator ShareAndroidText()
    {
        ...
        body = "Earn Bonus " + SignupBonus.ToString() + " Rs by inviting your friends to download and play " + PlayerPrefs.GetString("GameName") + ". Bonus amount will be credited to your account when your friends signup using your invite code. " + reff.ToString() + " Download link :- " + StaticStrings.ShareApkLink;
    ...
    void Start()
    {
        ...
        string des = "Earn Bonus " + SignupBonus.ToString() + " Rs by inviting your friends to download and play this Game "+ PlayerPrefs.GetString("GameName") + ". Bonus amount will be credited to your account when your friends signup using your invite code. "+ reff.ToString();
