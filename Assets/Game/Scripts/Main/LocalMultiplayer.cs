...
public class LocalMultiplayer : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        LocalPlayerName1.text = "Player 2";
        LocalPlayerName2.text = "Player 3";
        LocalPlayerName3.text = "Player 4";
    }
    ...
    public void PlayLocal()
    {
        ...
        {
            LevelManager.Instance.LoadScene(GameManager.Instance.GameScene);
