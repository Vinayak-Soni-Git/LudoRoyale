...
public class GameGUIController : PunBehaviour
{
    ...
    private void Proceed()
    {
        ...
        // firstPrizeText.GetComponent<Text>().text = firstPlacePrize + " BDT";
        // secondPrizeText.GetComponent<Text>().text = secondPlacePrize + " BDT";
