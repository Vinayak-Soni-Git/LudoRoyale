namespace AssemblyCSharp
{
    public static class StaticStrings
    {
        ...
        public static string AndroidPackageName = "com.ludo.dream";
        public static string ITunesAppID = "11111111111";

        // Notifications
        public static string notificationTitle = "Ludo Dream";
        public static string notificationMessage = "Get your FREE fortune spin!";

        public static string baseURL = "https://ludo.jiyowin.co.in/";
        ...
        public static string contactus = "help@ludodream.fun";
        ...
        public static string SharePrivateLinkMessage = "Join me in Ludo Dream. My Private Room Code is:";
        public static string SharePrivateLinkMessage2 = "Download Ludo Dream from:";
        public static string ShareApkLink = "https://ludo.jiyowin.co.in/";
        public static string ShareScreenShotText = "I finished game in Ludo Dream. It's my score :-) Join me and download Ludo Dream:";

        public static string paymentURl = "https://ludo.jiyowin.co.in/deposite.php/";
